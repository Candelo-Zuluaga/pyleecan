...
class SolutionMat(Solution):
    ...
    def __init__(self, field=None, indice=None, axis_name=None, axis_size=None, type_element="triangle", label=None, dimension=2, unit="", init_dict = None, init_str = None):
        ...
        # Call Solution init
        super(SolutionMat, self).__init__(type_element=type_element, label=label, dimension=dimension, unit=unit)
    ...
    def copy(self):
        ...
        obj_copy = type(self)(field=field_val,indice=indice_val,axis_name=axis_name_val,axis_size=axis_size_val,type_element=type_element_val,label=label_val,dimension=dimension_val,unit=unit_val)
        return obj_copy

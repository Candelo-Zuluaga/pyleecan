...
class HoleM62(HoleMag):
    ...
    def __init__(self, W0=None, H0=None, H1=None, W0_is_rad=False, magnet_0=-1, Zh=36, mat_void=-1, magnetization_dict_offset=None, Alpha0=0, init_dict = None, init_str = None):
        ...
        # Call HoleMag init
        super(HoleM62, self).__init__(Zh=Zh, mat_void=mat_void, magnetization_dict_offset=magnetization_dict_offset, Alpha0=Alpha0)
    ...
    def compare(self, other, name='self', ignore_list=None, is_add_value=False):
        ...
        # Check the properties inherited from HoleMag
        diff_list.extend(super(HoleM62, self).compare(other,name=name, ignore_list=ignore_list, is_add_value=is_add_value))
        ...
        if other._W0_is_rad != self._W0_is_rad:
            if is_add_value:
                val_str = ' (self='+str(self._W0_is_rad)+', other='+str(other._W0_is_rad)+')'
    ...
    def as_dict(self, type_handle_ndarray=0, keep_function=False, **kwargs):
        ...
        # Get the properties inherited from HoleMag
        HoleM62_dict = super(HoleM62, self).as_dict(type_handle_ndarray=type_handle_ndarray, keep_function=keep_function, **kwargs)
        ...
        if self.magnet_0 is None:
            ...
            HoleM62_dict["magnet_0"] = self.magnet_0.as_dict(type_handle_ndarray=type_handle_ndarray, keep_function=keep_function, **kwargs)
    ...
    def copy(self):
        ...
        obj_copy = type(self)(W0=W0_val,H0=H0_val,H1=H1_val,W0_is_rad=W0_is_rad_val,magnet_0=magnet_0_val,Zh=Zh_val,mat_void=mat_void_val,magnetization_dict_offset=magnetization_dict_offset_val,Alpha0=Alpha0_val)
        return obj_copy

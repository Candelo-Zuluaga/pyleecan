...
class SlotW23(Slot):
    ...
    def __init__(self, W0=None, H0=None, H1=None, W1=None, H2=None, W2=None, H1_is_rad=False, is_cstt_tooth=False, W3=None, Zs=36, wedge_mat=None, is_bore=True, init_dict = None, init_str = None):
    ...
    def copy(self):
        ...
        obj_copy = type(self)(W0=W0_val,H0=H0_val,H1=H1_val,W1=W1_val,H2=H2_val,W2=W2_val,H1_is_rad=H1_is_rad_val,is_cstt_tooth=is_cstt_tooth_val,W3=W3_val,Zs=Zs_val,wedge_mat=wedge_mat_val,is_bore=is_bore_val)
        return obj_copy

...
class Solution(FrozenClass):
    ...
    def __init__(self, type_element="triangle", label=None, dimension=2, unit="", init_dict = None, init_str = None):
    ...
    def compare(self, other, name='self', ignore_list=None, is_add_value=False):
        ...
        if other._type_element != self._type_element:
            if is_add_value:
                val_str = ' (self='+str(self._type_element)+', other='+str(other._type_element)+')'
    ...
    def copy(self):
        ...
        obj_copy = type(self)(type_element=type_element_val,label=label_val,dimension=dimension_val,unit=unit_val)
        return obj_copy

...
class SolutionVector(Solution):
    ...
    def __init__(self, field=None, type_element="triangle", label=None, dimension=2, unit="", init_dict = None, init_str = None):
        ...
        self.field = field
        # Call Solution init
        super(SolutionVector, self).__init__(type_element=type_element, label=label, dimension=dimension, unit=unit)
    ...
    def copy(self):
        ...
        obj_copy = type(self)(field=field_val,type_element=type_element_val,label=label_val,dimension=dimension_val,unit=unit_val)
        return obj_copy

...
class LamSlotMag(LamSlotM):
    ...
    def __init__(self, magnet=-1, mur_lin_matrix=None, Brm20_matrix=None, slot=-1, L1=0.35, mat_type=-1, Nrvd=0, Wrvd=0, Kf1=0.95, is_internal=True, Rint=0, Rext=1, is_stator=True, axial_vent=-1, notch=-1, skew=None, bore=None, yoke=None, init_dict = None, init_str = None):
        ...
        self.magnet = magnet
        # Call LamSlotM init
        super(LamSlotMag, self).__init__(mur_lin_matrix=mur_lin_matrix, Brm20_matrix=Brm20_matrix, slot=slot, L1=L1, mat_type=mat_type, Nrvd=Nrvd, Wrvd=Wrvd, Kf1=Kf1, is_internal=is_internal, Rint=Rint, Rext=Rext, is_stator=is_stator, axial_vent=axial_vent, notch=notch, skew=skew, bore=bore, yoke=yoke)

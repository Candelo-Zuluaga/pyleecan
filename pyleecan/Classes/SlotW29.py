...
class SlotW29(Slot):
    ...
    def __init__(self, W0=0.05, H0=0.001, H1=0.0015, W1=0.015, wedge_type=0, H2=0.03, W2=0.2, Zs=36, wedge_mat=None, is_bore=True, init_dict = None, init_str = None):
    ...
    def copy(self):
        ...
        obj_copy = type(self)(W0=W0_val,H0=H0_val,H1=H1_val,W1=W1_val,wedge_type=wedge_type_val,H2=H2_val,W2=W2_val,Zs=Zs_val,wedge_mat=wedge_mat_val,is_bore=is_bore_val)
        return obj_copy

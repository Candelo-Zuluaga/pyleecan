...
class NotchEvenDist(Notch):
    ...
    def __init__(self, alpha=0, notch_shape=-1, key_mat=None, init_dict = None, init_str = None):
    ...
    def copy(self):
        ...
        obj_copy = type(self)(alpha=alpha_val,notch_shape=notch_shape_val,key_mat=key_mat_val)
        return obj_copy

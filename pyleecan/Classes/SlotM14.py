...
class SlotM14(Slot):
    ...
    if isinstance(is_airgap_active, ImportError):
        is_airgap_active = property(
            fget=lambda x: raise_(
                ImportError(
                    "Can't use SlotM14 method is_airgap_active: " + str(is_airgap_active)
                )
            )
        )
    else:
    ...
    def __init__(self, W0=0.0122, H0=0.001, W1=0.0122, H1=0.001, Rtopm=0.001, Zs=36, wedge_mat=None, is_bore=True, init_dict = None, init_str = None):
    ...
    def copy(self):
        ...
        obj_copy = type(self)(W0=W0_val,H0=H0_val,W1=W1_val,H1=H1_val,Rtopm=Rtopm_val,Zs=Zs_val,wedge_mat=wedge_mat_val,is_bore=is_bore_val)
        return obj_copy

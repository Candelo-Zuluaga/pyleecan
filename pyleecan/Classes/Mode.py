...
class Mode(SolutionMat):
    ...
    def __init__(self, nat_freq=None, order_circ=None, order_long=None, field=None, indice=None, axis_name=None, axis_size=None, type_element="triangle", label=None, dimension=2, unit="", init_dict = None, init_str = None):
        ...
        super(Mode, self).__init__(field=field, indice=indice, axis_name=axis_name, axis_size=axis_size, type_element=type_element, label=label, dimension=dimension, unit=unit)
    ...
    def copy(self):
        ...
        obj_copy = type(self)(nat_freq=nat_freq_val,order_circ=order_circ_val,order_long=order_long_val,field=field_val,indice=indice_val,axis_name=axis_name_val,axis_size=axis_size_val,type_element=type_element_val,label=label_val,dimension=dimension_val,unit=unit_val)
        return obj_copy

...
class SlotW14(Slot):
    ...
    def __init__(self, W0=0.0122, H0=0.001, H1=0, H3=0.0122, wedge_type=0, W3=0.0122, H1_is_rad=False, Zs=36, wedge_mat=None, is_bore=True, init_dict = None, init_str = None):
    ...
    def compare(self, other, name='self', ignore_list=None, is_add_value=False):
        ...
        if other._wedge_type != self._wedge_type:
            if is_add_value:
                val_str = ' (self='+str(self._wedge_type)+', other='+str(other._wedge_type)+')'
    ...
    def copy(self):
        ...
        obj_copy = type(self)(W0=W0_val,H0=H0_val,H1=H1_val,H3=H3_val,wedge_type=wedge_type_val,W3=W3_val,H1_is_rad=H1_is_rad_val,Zs=Zs_val,wedge_mat=wedge_mat_val,is_bore=is_bore_val)
        return obj_copy
